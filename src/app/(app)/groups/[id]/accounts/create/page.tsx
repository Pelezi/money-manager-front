...
export default function GroupCreateAccountPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.userId) basePayload.userId = formData.userId;
      ...
      router.push(`/groups/${groupId}/accounts`);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-6">
          <button
            onClick={() => router.push(`/groups/${groupId}/accounts`)}
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Crie uma nova conta para o grupo
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <AccountForm
            ...
            onCancel={() => router.push(`/groups/${groupId}/accounts`)}
            loading={loading}
            isEditing={false}
            groupId={groupId}
